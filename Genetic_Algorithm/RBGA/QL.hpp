...
#define LAMBDA_INICIAL 0.2

///Defines dos valores de Recompensa
#define RCP_COMPLETA 1.0
#define RCP_MATA 0.2
#define RCP_ANDA_DESTINO 0.01

///Defines dos valores de Punição
#define PUN_INCOMPLETO 0.1
#define PUN_ERRA 0.5
#define PUN_ENCONTRADO 1.0
#define PUN_ANDA_SEM_CAMINHO 0.5
#define PUN_NAO_ESCONDE 0.1
...
class Fugitivo_RL : public Fugitivo {
	public:
		...
		float lambda;					///Taxa de decaimento dos 'traces'
