...
#define QVALUE_MAX 100.0
#define QVALUE_MIN -100.0
...
///Defines do Dyna-Q
#define N 			20
#define REWARD_PRI	0.1		///S,A que recebm reforço maior ou igual que REWARD_PRI são consiredarados prioritários
#define PRI_SWEEP 	7		///80% das atualizações baseadas no modelo são feitas usando S,A prioritárias
